...
<p><strong>v3.0 is the current stable direct-distribution release.</strong><br/>The Expo and React Native client brings Aniraku discovery, source-aware native playback, complete website-provider parity, repaired AniSkip timing, responsive high-episode-count navigation, selected-episode information, resilient public Downloads-folder saves for eligible direct sources, guarded embedded-player navigation, and the same protected AniList/MyAnimeList library-sync route used by aniraku.tech to Android 9+ devices.</p>
...
<p>
  ...
  <a href="https://github.com/Aniraku/Aniraku-App/releases/tag/v3.0"><img src="https://img.shields.io/badge/v3.0-FF4D4D?style=flat-square&logo=github&logoColor=111827" alt="Aniraku v3.0 stable release" /></a>
